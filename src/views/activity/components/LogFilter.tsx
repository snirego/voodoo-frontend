...
const commentCheckboxes = [
    { label: 'Show', value: COMMENT },
    //{ label: 'Mentioned you', value: COMMENT_MENTION },
]

const ticketCheckboxes = [
    { label: 'Youtube', value: UPDATE_TICKET },
    { label: 'Instagram', value: ASSIGN_TICKET },
    { label: 'Tiktok', value: CREATE_TICKET },
    ...
    const renderLogFilterContent = () => {
        return (
            <>
                ...
                >
                    <CategoryTitle className="mb-3">Shorts Uploaded</CategoryTitle>
                    ...
                    <CategoryTitle className="mt-4 mb-3">Shorts Created</CategoryTitle>
