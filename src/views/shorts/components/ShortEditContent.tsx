...
import ShortForm, { FormikRef, FormModel } from './ShortForm'
import dayjs from 'dayjs'

const ShortEditContent = forwardRef<FormikRef>((_, ref) => {
...
ShortEditContent.displayName = 'ShortEditContent'

export type { FormikRef }

export default ShortEditContent
