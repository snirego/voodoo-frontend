...
const ListItem = ({ data, cardBorder }: ListItemProps) => {
  ...
  return (
    <div className="mb-4 w-full">
      <Card bordered={cardBorder}>
        <div className="grid gap-x-4 grid-cols-12">
          <div className="my-1 col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-3 flex items-center">
            <div className="flex flex-col">
              <h6 className="font-bold">
          ...
          <div className="my-1 col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-3 flex items-center">
            <div className="inline-flex items-center px-2 py-1">
              <span className="ml-1 rtl:mr-1 whitespace-nowrap">
              shorts uploaded - {completedTask} / {totalTask}
              </span>
            </div>
          </div>
          <div className="my-1 ml-8 col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-3 flex items-center">
            <ProgressionBar progression={progression} />
          </div>
          <div className="my-1 col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-3 flex items-center justify-end">
            <ItemDropdown />
          </div>
        </div>
      </Card>
